...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
            ...
            .antMatchers("/**/cadastrar").hasAnyAuthority(Perfil.ADMIN.toString())
            .antMatchers("/**/editar").hasAnyAuthority(Perfil.ADMIN.toString())
            .antMatchers("/**/excluir").hasAnyAuthority(Perfil.ADMIN.toString())
